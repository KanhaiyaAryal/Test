...
<body>
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to Library Management System.</h1>
    </div>
  ...
  <div class="container__child signup__form">
    <form action="#" runat="server">
      <div class="form-group">
        ...
        <asp:TextBox ID="studentid" runat="server" CssClass="form-control" placeholder="G123452N"></asp:TextBox>
            <asp:RequiredFieldValidator runat="server" ControlToValidate="studentid"
                                CssClass="text-danger" ErrorMessage="Student ID is required."/> 
      </div>
      <div class="form-group">
      ...
      <div class="m-t-lg">
        <ul class="list-inline">
          <li>
              <asp:Button ID="Button1" runat="server" Text="Register" class="btn btn--form" OnClick="Button1_Click" style="background-color:#617129; color:white;"/>
          </li>
          <li>
